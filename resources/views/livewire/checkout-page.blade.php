			...
			<div class="md:col-span-12 lg:col-span-8 col-span-12">
				...
				<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
					...
					<div class="mb-6">
						...
						<div class="grid grid-cols-2 gap-4">
							<div>
								...
								dark:border-none @error('first_name')
									border-red-500
							...
							<div>
								...
								dark:border-none @error('last_name')
								border-red-500
						...
						<div class="mt-4">
							...
							dark:border-none @error('street_address')
							border-red-500
						...
						<div class="grid grid-cols-2 gap-4 mt-4">
							<div>
								...
								<input wire:model='province' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white 
								dark:border-none  @error('province')
								border-red-500
							@enderror" id="province" type="text">
								</input>
								@error('province')
									<div class="text-red-500 text-sm">{{ $message }}</div>
								@enderror
							...
							<div>
								...
								dark:border-none @error('zip_code')
								border-red-500
					...
					<ul class="grid w-full gap-6 md:grid-cols-2">
						...
						<li>
							<input wire:model='payment_method' class="hidden peer" id="hosting-blg" type="radio" value="stripe">
							<label class="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700" for="hosting-blg">
								<div class="block">
									<div class="w-full text-lg font-semibold">
										Stripe
									</div>
