<div>
  <div class="w-full h-screen bg-black bg-opacity-90 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      <div>
        <h1 class="block text-3xl font-bold text-white sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
          <span class="text-white">UrbanFashion</span>    <p class="mt-3 text-lg text-gray-800 dark:text-gray-400"></p>
...
<section class="py-20 w-full h-screen py-20 px-4 sm:px-6 lg:px-8 mx-auto" style="background-color: #525252"">
  <div class="max-w-xl mx-auto">
    <div class="text-center ">
      <div class="relative flex flex-col items-center">
        <h1 class="text-5xl font-bold text-white"> Browse Popular<span class="text-white"> Brands
          </span> </h1>
...
<section class="py-14 font-poppins bg-black bg-opacity-90">
  <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
    <div class="max-w-xl mx-auto">
      <div class="text-center ">
        <div class="relative flex flex-col items-center">
          <h1 class="text-5xl font-bold text-white"> Customer <span class="text-white"> Reviews
            </span> </h1>
          <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
            <div class="">
            </div>
