          ...
          <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody>
              ...
              <tr class="odd:bg-white even:bg-gray-100 dark:odd:bg-slate-900 dark:even:bg-slate-800" wire:key='{{ $order->id }}'>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200"><span class=""  style="text-transform: capitalize;">{{ $order->status }}</span></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200"><span class=""  style="text-transform: capitalize;">{{ $order->payment_status }}</span></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ Number::currency($order->grand_total, 'PHP') }} </td>
